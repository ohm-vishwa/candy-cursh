import { View, Text, ImageBackground, Animated, Alert } from 'react-native'
...
const GameScreen: FC = () => {
    ...
    const { completeLevel, unlocksLevel } = useLevelStore();
    ...
    return (
        <ImageBackground source={require('../assets/images/b1.png')} style={commonStyles.simpleContainer}>
            <GameHeader totalCount={totalCount} collectedcandies={collectedcandies} time={time} />
            {
                ...
                showAnimation && (
                    <>
                        <Animated.Image source={require('../assets/text/t2.png')}
                            style={[
                                styles.centerImage,
                                {
                                    opacity: fadeAnim,
